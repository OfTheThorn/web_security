    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            A secure website, built using the Laravel 8.
                            Please check out the README for further details.
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a
                                href="https://github.com/OfTheThorn/web_security"
                                class="underline text-gray-900 dark:text-white">GitHub</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Full website can be found at GitHub.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                <a href="https://ofthethorn.be/privacy">Privacy policy</a>
            </div>
        </div>
    </div>
</div>
